...
This program will calibrate the camera.  It will write the distortion coefficients and camera matrix to the config file.
...
def calibrateCamera():
	...
	# undistort using curved path remapping
...
def undistortImage(img, camMatrix, distCoeff):
	h,  w = img.shape[:2]
